...
`./decode_gray_code.exe target_graycode_imgs.txt 512 384 -white_thresh=3 -black_thresh=50`

4. 3次元復元  
`./procam_triangulation.exe -xMap=x.exr -yMap=y.exr -mask=x.png -cam=camera_data.yml -proj=proj_data.yml -rt=extrinsics.yml -texture=cap_target/DSC04088.JPG`
